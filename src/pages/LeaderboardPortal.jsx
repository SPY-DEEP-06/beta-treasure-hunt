...
export default function LeaderboardPortal() {
  ...
  return (
    <div className="min-h-screen p-8 text-white bg-slate-900">
      ...
      {gpsEnabled && (
        <div className="max-w-4xl mx-auto mb-8 rounded-2xl overflow-hidden border border-slate-700/50">
          ...
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead>
              <tr className="bg-white/5 border-b border-white/10">
                <th className="p-4 font-semibold text-slate-300 whitespace-nowrap">Rank</th>
                <th className="p-4 font-semibold text-slate-300 whitespace-nowrap">Team Name</th>
                <th className="p-4 font-semibold text-slate-300 whitespace-nowrap">Current Clue</th>
                <th className="p-4 font-semibold text-slate-300 whitespace-nowrap text-right">Progress</th>
              </tr>
            </thead>
            <tbody>
